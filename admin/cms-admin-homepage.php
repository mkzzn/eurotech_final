...
function delArticle(id, title)
{
	...
	{
		window.location.href = 'cms-admin-homepage.php?del=' + id;
	}
}
</script>
</head>
...
<table width="400" border="0" cellpadding="5" cellspacing="1">
 <tr align="center" bgcolor="#CCCCCC"> 
  <td width="220" align="left"><strong>About Section</strong> <a href="cms-add.php?section=About">(new)</a></td>
  <td width="180"></td>
 </tr>
 <?php
...
<table width="400" border="0" cellpadding="5" cellspacing="1">
 <tr align="center" bgcolor="#CCCCCC"> 
  <td width="220" align="left"><strong>Sub-About Section</strong> <a href="cms-add.php?section=SubAbout">(new)</a></td>
  <td width="180"></td>
 </tr>
 <?php
	while(list($id, $title, $section) = mysql_fetch_array($result, MYSQL_NUM))
...
<br>
	...
	<br>Image Caption: <a href="cms-admin-homepage.php?imagecaption=about">edit</a><br>
	
	<?php
	if($_GET['imagecaption'] == "about")
	{
	?>
	<form method="post" action="cms-admin-homepage.php">
