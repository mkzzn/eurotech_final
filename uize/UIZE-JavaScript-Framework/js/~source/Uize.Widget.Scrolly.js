								...
								/*?
									Instance Properties
										fade
											...
											The =fade= instance is created during the construction of the =Uize.Widget.Scrolly= instance, so the fade properties can be modified immediately after the scrolly is created. The behavior of the animation can be controlled by setting values for the various set-get properties of the =fade= instance, such as its =curve=, =duration=, and other set-get properties.
