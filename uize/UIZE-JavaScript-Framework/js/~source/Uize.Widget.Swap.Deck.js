				...
				_itemNo:{
					...
					/*?
						Set-get Properties
							...
							value
								An alias to the =itemNo= set-get property, establishing the =itemNo= property as the public Value Interface for this class.
					*/
				},
				_totalItems:{
					name:'totalItems',
