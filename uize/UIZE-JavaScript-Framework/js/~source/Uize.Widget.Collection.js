		...
		In a Nutshell
			...
			Collection Item Widget Naming
				...
				Explicit Naming of Collection Item Widgets
					When a collection item widget is added as a child widget of the collection, the element out of the =items= array that corresponds to the collection item being added is supplied as the value of the collection item widget's =properties= set-get property.
					...
					In the above example, the newly created collection widget will have two collection item child widgets: one named ='bravingTheOnslaught'=, and the other named ='flockOfClouds'=. The =items= set-get property specifies the array of data for the items in the collection. The value of each element is passed to the corresponding collection item child widget, through its =properties= set-get property. But the =widgetName= property is treated specially in this example. That's because the =itemPropertyForItemWidgetName= set-get property calls out the =widgetName= property as the property that should determine the name of the collection item widgets.

				Automatic Naming of Collection Item Widgets
					When =itemPropertyForItemWidgetName= is set to the value =null=, =undefined=, or =''= (empty string), or if the value of the item property specified by =itemPropertyForItemWidgetName= is =null=, =undefined=, or =''= (empty string), then the name of the child widget for a collection item will be generated using the value of the =itemWidgetNamePrefix= set-get property as a prefix and appending an automatically incremented uniquifier.
					...
					In the above example, the newly created collection widget will have two collection item child widgets: one named ='photoItem0'=, and the other named ='photoItem1'=. This is because the =itemPropertyForItemWidgetName= set-get property is set to =null=, thereby defeating the `Explicit Naming of Collection Item Widgets`, and because the =itemWidgetNamePrefix= set-get property is set to ='photoItem'=. The uniqifier value starts at =0=, and is incremented for each item added to the collection. This results in the collection item widget names ='photoItem0'= and ='photoItem1'=.
*/
							...
							/*?
								Instance Properties
									itemWidgets
										...
										- see the related =items= set-get property
								...
								/*?
									Child Widgets
										selectAll Child Widget
											...
											- the value of the =allSelected= set-get property is =true=
											- the value of the =isEmpty= set-get property is =true=
											- the value of the =selectionMode= set-get property is ='single'= and the value of the =totalItems= set-get property is not =1=
								...
								/*?
									Child Widgets
										selectNone Child Widget
											...
											This button is disabled whenever the value of the =someSelected= set-get property is =false=. Put another way, this button is only enabled when the value of =someSelected= is =true=.
					...
					Instance Methods
						addControlButton
							...
							enabledWhenSTRorOBJ
								...
								The value of this parameter can be of type string or type object. When a string value is specified for this parameter, then the value should be the name of a set-get property of the collection widget whose value will determine the button's enabled state. An optional "!" (exclamation mark) prefix allows you to not the value of the set-get property specified in the =enabledWhenSTRorOBJ= parameter.
								...
								The value of the =affectedBy= property of this object allows you to declare the name of a single set-get property of the collection widget instance that affects the enabled state of the button, or an array of the names of multiple set-get properties of the instance that affect the button's enabled state. The collection widget instance will watch on a change in the value of this property or properties, and will execute the state evaluator function specified in the =stateEvaluator= property each time there is such a change.

								The function you specify in the =stateEvaluator= property should return a boolean value, indicating whether or not the button should be enabled. Your function will not receive any parameters, but it *will* be called as an instance method on the collection instance, so it will be able to access the values of the set-get properties that affect the button's enabled state by using the =get= instance method. For good examples of how the =addControlButton= method can be used in the creation of your own subclasses, look at the implementation of this class.
				...
				/*?
					Instance Methods
						getItemWidgetProperties
							For advanced developers only, this is a subclassing hook that lets you override the default use of the =itemWidgetProperties= set-get property in the =addItemWidget= instance method.
				...
				/*?
					Instance Methods
						makeItemWidgetName
							...
							The =itemOBJ= parameter can be used to supply a reference to the =properties= "bucket" for additional item data. When an object is specified for the =itemOBJ= parameter, and when the =itemPropertyForItemWidgetName= set-get property is set to a non-empty string, and when the value of the property in the =itemOBJ= object specified by the =itemPropertyForItemWidgetName= property is a non-empty string, then that property will be returned as the item widget name. Otherwise, the item widget name will be generated by concatenating the value of the =itemWidgetNamePrefix= set-get property with a dynamically generated and automatically incremented uniquifier value.
							...
							NOTES
							- this is a hook method that can be used by a subclass
							- see the related =itemPropertyForItemWidgetName= and =itemWidgetNamePrefix= set-get properties
				*/
			};
					...
					Instance Methods
						getPropertyForItems
							...
							Getting All Properties
								When the special value =null= or =undefined= is specified for the =propertyNameSTR= parameter, then the =getPropertyForItems= method will return an array containing the values of the =properties= set-get property for all of the specified items.
								...
								Note that the elements of the returned array will be the values of the =properties= set-get property for the specified items. Given that the =properties= set-get property for collection item widgets is an object, the elements array returned by the =getPropertyForItems= method will contain references to the same objects shared by the item widgets. Therefore, modifying the values of the objects in the returned array will have an affect on the item widgets. In cases where you wish to modify the returned data, you should probably use the =Uize.clone= static method to create your own clone of this data before modifying it.
				...
				/*?
					Instance Methods
						selectAll
							...
							Calling this method has the effect of setting the value of the =selected= set-get property of all collection item widgets to =true=. Calling this method will also result in the values of the =allSelected=, =oneSelected=, =someSelected=, and =totalSelected= set-get properties being updated, upon which some of these properties may change value.
							...
							- see the related =allSelected=, =oneSelected=, =someSelected=, and =totalSelected= set-get properties
				*/
			};
				...
				/*?
					Instance Methods
						selectRange
							...
							Calling this method has the effect of setting the value of the =selected= set-get property of all collection item widgets within the specified range to =true=, and all collection item widgets outside of the specified range to =false=. The range is specified by the =itemWidgetAOBJ= and =itemWidgetBOBJ= parameters, and is inclusive of the two item widgets that are specified by these parameters. The order of the range bounds is unimportant - the item specified by =itemWidgetAOBJ= can be before or after the item specified by =itemWidgetBOBJ= in the =itemWidgets= array.

							Calling this method will result in the values of the =allSelected=, =oneSelected=, =someSelected=, and =totalSelected= set-get properties being updated, upon which some of these properties may change value. Calling this method will have no effect if the values of either - or both - of the =itemWidgetAOBJ= or =itemWidgetBOBJ= parameters is =null= or =undefined=, or if the value of the =selectionMode= set-get property is ='single'= and the values of the =itemWidgetAOBJ= and =itemWidgetBOBJ= parameters are not identical (ie. you can only select a range of one item when =selectionMode= is set to ='single'=, and trying to select a range of more than one item will result in no action).
					...
					/*?
						Set-get Properties
							allSelected
								...
								Whenever the value of the =totalSelected= set-get property changes, the value of this property will be updated to be kept current and correct. Whenever the value of this property is =true=, the value of the =someSelected= set-get property will also be =true=.

								The =Changed.allSelected= instance event can be wired in order to maintain enabled state of any UI elements whose enabled state is affected by whether or not all items are selected. For example, whenever this property is set to =true=, the =selectAll= child widget will be disabled. Conversely, whenever =allSelected= is set to =false=, the =selectAll= child widget will be enabled (provided that the =isEmpty= set-get property is not set to =true=).

								NOTES
								- this property is read-only
								- see the related =oneSelected=, =someSelected=, and =totalSelected= set-get properties
					...
					/*?
						Set-get Properties
							isEmpty
								...
								Whenever the value of the =totalItems= set-get property changes, the value of the =isEmpty= set-get property will be updated to be kept current and correct. When the =isEmpty= property is set to =true=, then the =selectAll Child Widget= will be disabled.
					...
					/*?
						Set-get Properties
							itemPropertyForItemWidgetName
								...
								NOTES
								- see the related =itemWidgetNamePrefix= set-get property
					...
					/*?
						Set-get Properties
							items
								...
								Each element of the =items= array should be an object, which serves as a "bucket" for additional data for an item. When a collection item widget is created for an item in the =items= array, the element from the =items= array is used as the value of the item widget's =properties= set-get property.
					...
					/*?
						Set-get Properties
							itemWidgetNamePrefix
								...
								NOTES
								- see the related =itemPropertyForItemWidgetName= set-get property
					...
					/*?
						Set-get Properties
							itemWidgetProperties
								An object reference, specifying the values for any set-get properties that are common for all collection item widgets that are created by this class.
								...
								In the above example, we're setting the =itemWidgetProperties= set-get property to the value ={previewClickAction:'Select'}=. This means that the two collection item child widgets that are created will both have their =previewClickAction= set-get property set to the value ='Select'=, which means that clicking on them will change their selected state.
					...
					/*?
						Set-get Properties
							oneSelected
								...
								NOTES
								- this property is read-only
								- see the related =allSelected=, =someSelected=, and =totalSelected= set-get properties
								- the initial value is =false=
					*/
				},
				_selectionMode:{
					...
					/*?
						Set-get Properties
							someSelected
								...
								Whenever the value of the =totalSelected= set-get property changes, the value of this property will be updated to be kept current and correct. The value of this property will be =true= when the value of the =oneSelected= set-get property is =true=.
								...
								NOTES
								- this property is read-only
								- see the related =allSelected=, =oneSelected=, and =totalSelected= set-get properties
								- the initial value is =false=
					*/
				},
				_totalItems:{
					...
					/*?
						Set-get Properties
							totalItems
								...
								Whenever the total number of items in the collection changes, either as a result of adding new items or removing items, the value of the =isEmpty= set-get property will be updated to be kept current and correct, and the =totalItems Implied Node= will be updated to reflect the new number of items in the collection.

								NOTES
								- this property is read-only
								- see the related =isEmpty= set-get property
					...
					/*?
						Set-get Properties
							totalSelected
								...
								Whenever the selection is changed, either by the user or programmatically, the value of this property will be updated. Whenever its value changes, the values of the =oneSelected=, =someSelected=, and =allSelected= set-get properties will be updated to be kept current and correct.

								NOTES
								- this property is read-only
								- see the related =allSelected=, =oneSelected=, and =someSelected= set-get properties
								- the initial value is =0=
					*/
				}
			});
