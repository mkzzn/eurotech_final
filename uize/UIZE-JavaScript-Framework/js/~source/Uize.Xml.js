...
Uize.module ({
	...
	builder:function () {
		...
		/*** Utility Functions ***/
			...
			function _getEncodedCharacter (_character) {return _entitiesToEncodeMap [_character]}

		/*** Public Static Methods ***/
			var _toAttributeValue = _package.toAttributeValue = function (_toEncode) {
				return (_toEncode += '') && _toEncode.replace (/[&\n\r"'<>]/g,_getEncodedCharacter);
							...
							return (
								String.fromCharCode (
									_entityNumber
										...
										: (Uize.isFunction (_entityMap) ? _entityMap () : _entityMap) [_entityName]
								)
							);
						}
					)
